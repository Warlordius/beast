...
public class ParserReuters extends Parser {
	...
	/** 
	 * Extracts articles making the latest headlines from a page (currently, reuters type is assumed), that are used as a starting point for search 
	 * 
	 * @param page - page where links of latest headlines are expected to be found
	...
	/**
	 * Processes a link string and returns a valid full url string prefixed with protocol
	 * 
	...
	/**
	 * Parses the content of a Reuters page and updates the given fields
	 * of the page object passed to the method. Updated field include perex and text,
	 * updated every time and location plus timestamp, updated if available.
	 * 
	 * @param page - Page to be parsed and updated.
	 * @return StringBuffer containing the text of the article in the parsed page.
	 */
	...
	/**
	 * Returns the starting pages extracted from the reuters home page. Currently is set
	 * to extract starting pages from news making headlines.
	 * 
